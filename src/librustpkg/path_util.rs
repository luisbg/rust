...
pub fn workspace_contains_package_id(crateid: &CrateId, workspace: &Path) -> bool {
    workspace_contains_package_id_(crateid, workspace, |p| p.join("src")).is_some()
}

pub fn workspace_contains_package_id_(crateid: &CrateId, workspace: &Path,
